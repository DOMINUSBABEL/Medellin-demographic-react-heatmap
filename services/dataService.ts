...
// For polygons, we use the centroid for context
const generatePolygonLimits = (polygon: [number, number][]): string => {
    // Simple bounding box of the polygon for display
...
// Intermediate structure to hold clustered points before Voronoi
...
const aggregateClusterData = (node: ClusterNode, polygon: [number, number][], index: number, totalBoundsArea: number): ZoneData => {
  ...
  return {
    ...
    polygon: polygon, // THE IRREGULAR SHAPE
...
// --- K-D TREE RECURSION (To find Clusters) ---
...
const buildKDTreeClusters = (
  ...
  if (depth === 0 || points.length === 0) {
    ...
    // Calculate Center of Mass of this cluster
...
export const processKDTree = (rawPoints: ZoneData[], depth: number = 8): ZoneData[] => {
  ...
  // Add buffer for the map boundary
  const pad = 0.01;
...
const COMUNA_PROFILES = [
  // --- ZONA NORORIENTAL ---
  {
    ...
    baseStrata: 1, densityFactor: 0.98, spread: 0.006, ageRange: [15, 40],
  ...
  },
  {
    ...
    baseStrata: 2, densityFactor: 0.95, spread: 0.005, ageRange: [18, 50],
  ...
  },
  {
    ...
    baseStrata: 2, densityFactor: 0.90, spread: 0.007, ageRange: [20, 60],
    educationBias: [EducationLevel.Secondary, EducationLevel.Technical],
  ...
  },
  {
    ...
    baseStrata: 3, densityFactor: 0.88, spread: 0.007, ageRange: [25, 70],
  ...
  // --- ZONA NOROCCIDENTAL ---
  {
    ...
    baseStrata: 3, densityFactor: 0.92, spread: 0.007, ageRange: [22, 55],
    educationBias: [EducationLevel.Secondary, EducationLevel.Technical],
  ...
  },
  {
    ...
    baseStrata: 2, densityFactor: 0.96, spread: 0.006, ageRange: [16, 45],
    educationBias: [EducationLevel.Secondary, EducationLevel.Technical],
    interests: [SocialInterest.Music, SocialInterest.Sports]
  },
  {
    ...
    baseStrata: 3, densityFactor: 0.85, spread: 0.012, ageRange: [18, 50],
  ...
  // --- ZONA CENTRO ---
  {
    ...
    baseStrata: 2, densityFactor: 0.90, spread: 0.007, ageRange: [20, 55],
    educationBias: [EducationLevel.Secondary, EducationLevel.Technical],
    interests: [SocialInterest.Music, SocialInterest.Sports]
  },
  {
    ...
    baseStrata: 3, densityFactor: 0.85, spread: 0.008, ageRange: [25, 60],
    educationBias: [EducationLevel.University, EducationLevel.Technical],
  ...
  },
  {
    ...
    baseStrata: 3, densityFactor: 0.70, spread: 0.006, ageRange: [25, 55],
    educationBias: [EducationLevel.University, EducationLevel.Technical],
    interests: [SocialInterest.Politics, SocialInterest.Tech]
  },
  ...
  // --- OCCIDENTE ---
  {
    ...
    baseStrata: 5, densityFactor: 0.78, spread: 0.008, ageRange: [25, 75],
  ...
  },
  {
    ...
    baseStrata: 4, densityFactor: 0.82, spread: 0.007, ageRange: [30, 65],
    educationBias: [EducationLevel.University, EducationLevel.Technical],
  ...
  },
  {
    ...
    baseStrata: 2, densityFactor: 0.94, spread: 0.007, ageRange: [15, 35],
    educationBias: [EducationLevel.Secondary, EducationLevel.Technical],
  ...
  // --- SUR ---
  {
    ...
    baseStrata: 6, densityFactor: 0.45, spread: 0.016, ageRange: [30, 75],
    educationBias: [EducationLevel.University, EducationLevel.Postgrad],
  ...
  },
  {
    ...
    baseStrata: 3, densityFactor: 0.65, spread: 0.009, ageRange: [30, 60],
  ...
  },
  {
    ...
    baseStrata: 4, densityFactor: 0.84, spread: 0.012, ageRange: [25, 65],
    educationBias: [EducationLevel.University, EducationLevel.Technical],
